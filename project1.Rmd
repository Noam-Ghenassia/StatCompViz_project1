...
In this project, we will analyse data from the IPUMS USA database, which provides access to over sixty integrated, high-precision samples of the American population drawn from sixteen federal censuses.
...
```{r income vs origin boxplot, echo = FALSE}
